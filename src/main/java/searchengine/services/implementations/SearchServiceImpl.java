...
public class SearchServiceImpl implements SearchService {
    ...
    public SearchResponse search(String query, int offset, int limit, String site) {
        ...
        float maxAbsoluteRelevanceInPage = 0.0f;
        for (Map.Entry<PageEntity, Float> entry : absoluteRelevanceInPage.entrySet()) {
            if (maxAbsoluteRelevanceInPage < entry.getValue()) {
                maxAbsoluteRelevanceInPage = entry.getValue();
            }
        }
        ...
        for (Map.Entry<PageEntity, Float> entry : absoluteRelevanceInPage.entrySet()) {
            ...
            float relativeRelevance = (absoluteRelevance / maxAbsoluteRelevanceInPage) * 1000;
